...
def controle_veiculos():
            ...
            with conn.cursor() as cursor:
                ...
                for reg_tuple in registros_db:
                    ...
                    if tipo_registro == 'abastecimento' and km_atual is not None:
                        ...
                        reg.append(consumo_km_litro_calc)      # Agora será o índice 12
                        reg.append(valor_por_litro_calc)        # Agora será o índice 13
                        reg.append(custo_por_km_individual_calc) # Agora será o índice 14 (o novo campo)
    ...
    return render_template('controle_veiculos.html',
                            ...
                            consumo_por_placa=consumo_por_placa, # Passando o dicionário de consumo por placa
                            custo_por_km_por_placa=custo_por_km_por_placa, # Passando o dicionário de custo por km por placa
...
class PDF(FPDF):
    ...
    def add_date_field(self):
        self.ln(5) # Espaço antes do campo de data
        self.set_font('Arial', '', 10)
        self.cell(0, 10, 'Data: _____/_____/________', 0, 1, 'L') # 'L' para alinhar à esquerda
        self.ln(5) # Espaço depois do campo de data
    
    def add_signature_adm_field(self, technician_name):
        self.ln(10)
        self.set_font('Arial', '', 10)
        self.cell(0, 10, 'Assinatura do Conferente: _________________________________________', 0, 1)
        self.ln(10)

    def add_cupons_field(self):
        self.ln(10)
        self.set_font('Arial', '', 10)
        self.cell(0, 10, 'Quantidade de Cupons Fiscais entregues: _____', 0, 1)
        self.ln(10)       
...
def exportar_rdv_pdf():
    ...
    pdf.add_signature_adm_field(admin_nome_completo) # Passa o nome do ADMIN para a assinatura do conferente

    pdf.add_cupons_field() # Se esta função não precisa de argumentos, a chamada é assim
